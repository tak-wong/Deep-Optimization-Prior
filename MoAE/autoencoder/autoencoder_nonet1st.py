...
class autoencoder_nonet1st(autoencoder):
    # -----------------------------------------------------------------------
    def __init__(self, dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose = True):
        super(autoencoder_nonet1st, self).__init__(dataset_name, dataset_filename, dir_data, dir_dest, verbose)
        ...
        if self.verbose:
            print('autoencoder_nonet1st.init')
...
#         str_summary, stat_summary = summary_string(self.network, input_size=(NC * NZ, NX, NY))
        return str_summary
