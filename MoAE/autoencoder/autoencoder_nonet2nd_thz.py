...
class autoencoder_nonet2nd_thz(autoencoder_nonet2nd):
    # -----------------------------------------------------------------------
    def __init__(self, dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose = True):
        super(autoencoder_nonet2nd_thz, self).__init__(dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose)
        ...
        if self.verbose:
            print("autoencoder_nonet2nd_thz.init")
