...
class autoencoder_unet(autoencoder):
    # -----------------------------------------------------------------------
    def __init__(self, dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose = True):
        super(autoencoder_unet, self).__init__(dataset_name, dataset_filename, dir_data, dir_dest, verbose)
