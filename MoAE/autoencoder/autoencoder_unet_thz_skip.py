...
class autoencoder_unet_thz_skip(autoencoder_unet_thz):
    # -----------------------------------------------------------------------
    def __init__(self, dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose = True):
        super(autoencoder_unet_thz_skip, self).__init__(dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose)
        
        if self.verbose:
            print("autoencoder_unet_thz_skip.init")
