...
class autoencoder_nonet1st_thz_reg(autoencoder_nonet1st):
    # -----------------------------------------------------------------------
    def __init__(self, dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose = True):
        super(autoencoder_nonet1st_thz_reg, self).__init__(dataset_name, dataset_filename, dir_data, dir_dest, hp, verbose)
        ...
        if self.verbose:
            print("autoencoder_nonet1st_thz_reg.init")
