...
class hyperparameter_nonet2nd_thz_randinit(hyperparameter_nonet2nd_thz):
    def __init__(self, use_seed = 0, learning_rate = 1.0, epochs = 1200):
        super(hyperparameter_nonet2nd_thz_randinit, self).__init__(use_seed, learning_rate, epochs)
