...
class hyperparameter_unet_thz_skip(hyperparameter):
    def __init__(self, use_seed = 0, learning_rate = 1.0, epochs = 1200):
        super(hyperparameter_unet_thz_skip, self).__init__(use_seed, learning_rate, epochs)
        
        # network unet
        self.NET_UNET_CHANNELS_DOWN = [16, 32, 64, 128]
        self.NET_UNET_CHANNELS_UP   = [16, 32, 64, 128]
        self.NET_UNET_CHANNELS_SKIP = [160, 160, 160, 160]
