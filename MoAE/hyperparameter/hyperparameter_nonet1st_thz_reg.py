...
class hyperparameter_nonet1st_thz_reg(hyperparameter_nonet1st_thz, hyperparameter_reg):
    def __init__(self, use_seed = 0, learning_rate = 1.0, epochs = 1200):
        super(hyperparameter_nonet1st_thz_reg, self).__init__(use_seed, learning_rate, epochs)
